...
function AboutUsPage() {
  const [notes, setNotes] = useState([
    { name: "Clara", profession: "Data Scientist", description: "lorem" },
    { name: "Miriam", profession: "UX Designer", description: "lorem" },
    { name: "Nora", profession: "Fullstack Developer", description: "lorem" },
    { name: "Sol", profession: "Fullstack Developer", description: "lorem" },
    {
      name: "Silvia",
    ...
    { name: "Reyes", profession: "Data Scientist", description: "lorem" },
  ]);
  return (
